...
if (fs.existsSync(FILE) && !fs.existsSync(FILE + ".bak-8.3")) {
  fs.copyFileSync(FILE, FILE + ".bak-8.3");
}
...
console.log("✓ wrote", FILE, "backup:", fs.existsSync(FILE + ".bak-8.3") ? FILE + ".bak-8.3" : "(none)");
