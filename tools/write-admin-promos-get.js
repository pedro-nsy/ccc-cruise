...
// node tools/write-admin-promos-get.js
const fs = require("fs");
const path = require("path");

const TARGET = path.join("src","app","api","admin","promos","route.ts");
const BACKUP = TARGET + ".bak-before-0.3B-v2";
...
(function main() {
  ...
  console.log("✓ Wrote GET route:", TARGET);
})();
