...
export default function GeneratorForm({
  ...
  // format hint removed per your preference (implicit now)
      ...
      <div className="rounded-2xl border bg-white p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="space-y-1">
            ...
            <p className="text-sm text-neutral-600">Create a single promo code. You can switch to bulk when needed.</p>
          </div>
...
writeWithBackup("GeneratorForm.tsx", generatorForm, "step4f");
